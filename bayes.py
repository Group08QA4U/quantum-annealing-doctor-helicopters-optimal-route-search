...
def main(qa_trial_count, width, height, num_of_patients, num_of_fire_departments, num_of_rendezvous_points, num_of_basehospitals):
    ...
    def objective(x):
        ...
        p, v = optimizer.bayes(x, qa_trial_count, width, height, num_of_patients, num_of_fire_departments, num_of_rendezvous_points, num_of_basehospitals)
    ...
    space = Space([
        ...
        #Real(35.0, 45.0, name='x1'),
        #Real(90.0, 100.0, name='x2'),
        #Real(0.0, 100.0, name='x3')
    ])
